...
export const toDoManager =(function () {
    function loadToDos()
    {
        ...
        currentSpaceTodos(space).forEach((el)=>{
            let todoToAdd = createToDo(el.name,el.desc,el.priority,el.dueDate,space);
    ...
    function createToDo(name="name",desc="demo",priority="high",date="20/10/2003",type=currentWorkingSpace)
    {
    ...
    function populateStorage(name,desc,priority,date,type)
    {
